...
//##########################################################################
//
#ifndef vombat_PLUGIN_BASEFILTER_HEADER
#define vombat_PLUGIN_BASEFILTER_HEADER
...
struct VombatFilterDescription
{
public:
    ...
    VombatFilterDescription(QString filterName, QString entryName, QString statusTip, QString icon)
...
/** \note Remember to override compute(), at least
	\author Luca Penasa
**/
class VombatBaseFilter: public QObject
{
	Q_OBJECT
...
public:
	...
	*/
    VombatBaseFilter(VombatFilterDescription desc = VombatFilterDescription(), ccPluginInterface * parent_plugin = 0);
...
protected:
	...
	**/
    VombatFilterDescription m_desc;
